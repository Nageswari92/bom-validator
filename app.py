    ...
    if st.button("🚀 Run BAVA TECH Audit System"):
        ...
        for index, (parent_part, data) in enumerate(assemblies.items()):
            ...
            try:
                ...
                # Helper to format component cell string alignment with master precision
                ...
                # Parent Quantity Checked maintaining exact decimal digits
                ...
                for child in child_rows:
                    ...
                    # Child Quantity Checked maintaining exact decimal digits
        ...
        # ==========================================
        # 3. Output Dashboard Rendering Section
        # ==========================================
        ...
        # Build optimized Unified Master Excel Report with Color Coding
        ...
        with pd.ExcelWriter(report_buffer, engine='openpyxl') as writer:
            ...
            for row_idx in range(2, ws.max_row + 1):
                audit_cell = ws.cell(row=row_idx, column=2)   # Column B: 'Audit Result'
